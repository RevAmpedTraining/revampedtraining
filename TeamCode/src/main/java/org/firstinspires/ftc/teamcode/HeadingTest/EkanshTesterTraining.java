package org.firstinspires.ftc.teamcode.HeadingTest;

import com.qualcomm.robotcore.eventloop.opmode.OpMode;
import com.revAmped.components.Button;
import com.revAmped.components.RobotRevAmpedSkystone;

@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "Tester")
public class EkanshTesterTraining extends OpMode {
    ...
    public void loop(){
        ...
        telemetry.addData("reset", "Start button");
