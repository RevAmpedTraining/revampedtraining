...
public class VuforiaTest
    ...
    public void runOpMode()
        ...
        while (opModeIsActive()) {
            telemetry.addData("Checking Jewel", "");
            if (bInit) { // only call OpenCV if bInit is true. otherwise, it caused robot to fail, unless try catch it.
                ...
                SampleOrderDetector.GoldenOrder order = sample.GetSampleOrder(origimg);
                ...
                //Bitmap templateB = vuSensor.vuforia.loadBitmapFromAssets("Matchhexgon.JPG");
                //Mat templ = new Mat(templateB.getHeight(), templateB.getWidth(), CvType.CV_8UC1);
                //jd.getHexgonPattern(origimg, templ);
    ...
    private void vuforiaTest() {
         ...
         */
        parameters.vuforiaLicenseKey = "";
        ...
        while (opModeIsActive() && (System.currentTimeMillis() - start_time) < 25000) {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                //Bitmap templateB = vuforia.loadBitmapFromAssets("Matchhexgon.JPG");
                //Mat templ = new Mat(templateB.getHeight(), templateB.getWidth(), CvType.CV_8UC1);
                //jd.getHexgonPattern(origimg, templ);
