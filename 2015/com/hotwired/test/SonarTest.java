...
public class SonarTest
    ...
    public void runOpMode() throws InterruptedException {
        ...
        I2cDevice sonarMaxBotixDevice = hardwareMap.i2cDevice.get("i2cdev");
        MaxSonarI2CXLRanger sonar = new MaxSonarI2CXLRanger(this,
                                                            sonarMaxBotixDevice);
    ...
    private int searchAddr (MaxSonarI2CXLRanger sonar)
        ...
        for (byte i = 2; i != 0; i += 2) {
            sonar.getI2cDeviceSynch().setI2cAddr(new I2cAddr(i));
            Thread.sleep(25);
            sonar.startRanging();
            Thread.sleep(100);
            int reading=sonar.getDistance();
