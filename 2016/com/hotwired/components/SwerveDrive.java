...
/**
 * Created by zwang on 10/28/2016.
 */
...
public class SwerveDrive
    ...
    public void setTurn(TurnType turnType) {
        ...
        switch (turnType) {
            case FORWARD:
                servoLeftBack.setPosition(RobotConstants.SERVO_LEFTBACK_START);
                servoLeftFront.setPosition(RobotConstants.SERVO_LEFTFRONT_START);

                servoRightBack.setPosition(RobotConstants.SERVO_RIGHTBACK_START);
                servoRightFront.setPosition(RobotConstants.SERVO_RIGHTFRONT_START);
                break;
            case TURN_REGULAR:
                servoLeftBack.setPosition((RobotConstants.SERVO_LEFTBACK_START + RobotConstants.SERVO_LEFTBACK_END)/2f);
                servoLeftFront.setPosition((RobotConstants.SERVO_LEFTFRONT_START + RobotConstants.SERVO_LEFTFRONT_END)/2f);

                servoRightBack.setPosition((RobotConstants.SERVO_RIGHTBACK_START + RobotConstants.SERVO_RIGHTBACK_END)/2f);
                servoRightFront.setPosition((RobotConstants.SERVO_RIGHTFRONT_START + RobotConstants.SERVO_RIGHTFRONT_END)/2f);
                break;
            case STRAFE:
                servoLeftBack.setPosition(RobotConstants.SERVO_LEFTBACK_END);
                servoLeftFront.setPosition(RobotConstants.SERVO_LEFTFRONT_END);

                servoRightBack.setPosition(RobotConstants.SERVO_RIGHTBACK_END);
                servoRightFront.setPosition(RobotConstants.SERVO_RIGHTFRONT_END);
                break;
