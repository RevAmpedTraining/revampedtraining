 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="AutonomousRevamped3glyph", group="Game")
                ...
                throws InterruptedException
        {
           ...
           // Boolean bInit = vuSensor.initialize();
            ...
            if (isNear) {
                ...
                robot.servoContainer.setPosition(RobotRevAmpedConstants.SERVO_CONTAINER_FLAT-25);
                lp.waitMillis(100);
                /**
